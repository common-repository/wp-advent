...
class WP_Advent_Plugin_Admin {
	...
	public function management_page(){
		if(isset($_POST['submit']) && isset($_POST['ap_form']) && ($_POST['ap_form'] == 'cbw')){
			check_admin_referer( 'wp_advent_cbw' );
			if(isset($_POST['blackwhite']) && ($_POST['blackwhite'] == 'y')){
				update_option('wp_advent_blackwhite',true);
			} else {
				update_option('wp_advent_blackwhite',false);
			}
		}
