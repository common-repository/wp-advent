<div class="wrap wp-advent-admin-wrapper">
    ...
    <form method="post">
        <label>
            <input type="checkbox" name="blackwhite" value="y">
            <?php _e('Set calendar sheets to black/white.','wp-advent'); ?>
        </label>
        <br>
        <input type="hidden" name="ap_form" value="cbw">
	    <?php wp_nonce_field( 'wp_advent_cbw' ); ?>
	    <?php submit_button(); ?>
    </form>
