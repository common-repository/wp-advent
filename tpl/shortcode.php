...
if ( is_feed() ) : ?>
	<?php echo __( 'Visit this page in your browser to see the advent calendar.','wp-advent' ); ?>
<?php else : ?>
    ...
    <div id="wp-advent-wrapper"
         class="year-<?php echo $calendar->getYear(); ?> calendar-<?php echo $calendar->getSlug(); ?>">
			...
			<?php for ( $i = 0; $i <= 23; $i ++ ): ?>
				...
				<?php if ( $active ): ?>
					...
					<?php if ( get_post_custom_values( 'wp_advent_image_id', $day->ID ) ) :
						...
						?>
                        <li>
                            <a href="<?php echo $image_url; ?>" class="calendar-sheet js-calendar-sheet-<?php echo $i; ?>">
								<?php echo $daydate; ?>
                            </a>
                        </li>
					<?php elseif ( get_post_custom_values( 'wp_advent_video_url', $day->ID )[0] ) :
						...
						?>
                        <li>
                            <a href="<?php echo $video_url; ?>" class="calendar-sheet js-calendar-sheet-<?php echo $i; ?>">
								<?php echo $daydate; ?>
                            </a>
                        </li>
					<?php else : ?>
                        <li class="day-<?php echo $day->ID; ?> status-<?php echo $day->post_status; ?>">
                            <a href="<?php echo get_permalink( $day->ID ) ?>" class="calendar-sheet js-calendar-sheet-<?php echo $i; ?>">
								<?php echo $daydate; ?>
                            </a>
                        </li>
					<?php endif; ?>
